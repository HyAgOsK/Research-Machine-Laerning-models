...
def video_input(data_src):
    ...
    vid_file = None
    if data_src == 'Dado de amostra':
        vid_file = "data/sample_videos/testcar.mp4"
    else:
    ...
    if vid_file:
        ...
        while True:
            ...
            output.image(output_img, channels="BGR")
...
def camera_input(camera):
    ...
    fps = 0
    fps_deque = deque(maxlen=20)  # Usando uma média móvel de 20 frames
    ...
    while True:
        ...
        st1_text.markdown(f"### **{height}**")
        st2_text.markdown(f"### **{width}**")
        st3_text.markdown(f"### **{avg_fps:.2f}**")
